...
var productionsTable = ProdTab{
	...
	ProdTabEntry{
		String: `GoStructField : ident GoType gotag TagDetail gotag	<< ast.NewGoStructField(X[0],X[3]) >>`,
		Id:         "GoStructField",
		NTType:     6,
		Index:      8,
		NumSymbols: 5,
		ReduceFunc: func(X []Attrib) (Attrib, error) {
			return ast.NewGoStructField(X[0], X[3])
		},
	},
	ProdTabEntry{
	...
	ProdTabEntry{
		String: `TagDetail : TagDetail ident	<<  >>`,
		Id:         "TagDetail",
		NTType:     8,
		Index:      14,
		NumSymbols: 2,
	...
	ProdTabEntry{
		String: `TagDetail : TagDetail dquote	<<  >>`,
		Id:         "TagDetail",
		NTType:     8,
		Index:      15,
		NumSymbols: 2,
	...
	ProdTabEntry{
		String: `TagDetail : TagDetail semicolon	<<  >>`,
		Id:         "TagDetail",
		NTType:     8,
		Index:      16,
		NumSymbols: 2,
	...
	ProdTabEntry{
		String: `TagDetail : TagDetail minus	<<  >>`,
		Id:         "TagDetail",
		NTType:     8,
		Index:      17,
		NumSymbols: 2,
